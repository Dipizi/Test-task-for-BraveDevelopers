...
import com.dipizi007.pokedexv20.domain.use_case.pokemons_databaseUC.PokemonsListService
...
class PokemonsListDbViewModel @Inject constructor(private val pokemonsListService: PokemonsListService) :
    ViewModel() {
